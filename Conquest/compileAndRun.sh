...
#java -cp bin conquest.Conquest 100 5000 "internal:conquest.bot.BotStarter" "process:java -cp /home/madam/School/AI/conquest/Conquest-Playground/bin conquest.bot.playground.ConquestBot" true replay.log
