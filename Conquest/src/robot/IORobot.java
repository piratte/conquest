...
public class IORobot implements Robot
{
	...
	public IORobot(String playerName, OutputStream input, InputStream output, InputStream error) throws IOException
	{
		handler = new Handler(playerName + "-Robot", input, output, error);
